    ...
    while (true) {
      ...
      if (opcao.equals("1")) {
        ...
        if (opcaoParaUsuario.equals("1")) {
          ...
          String mes = JOptionPane.showInputDialog(" Digite mes do seu nascimento:");
          ...
          Usuario usuario = new Usuario(nome, email, LocalDate.of(anoConvertido, mesConvertido, diaConvertido),
              endereco);
        ...
        if (opcaoParaLivro.equals("1")) {
          ...
          Livro livro = new Livro(titulo, autor, areaDeConhecimento, qtdDeCopiasConvertido,
          ...
          for (Livro livro : livros) {
            System.out
                .println("Título: " + livro.getTitulo() + "; Autor: " + livro.getAutor() + "; Data de publicação: "
                    + livro.getDataDePublicacao() + "; Quantidade de acervos: " + livro.getQtdDeCopias() + "\n");
          }
        }
              ...
              if (escolhaObjetoParaAlterar.equals("4")) {
                ...
                if (escolhaTituloDescricao.equals("1")) {
                  ...
                  String descricaoDaArea = JOptionPane
                      .showInputDialog("Digite a nova descrição da área de conhecimento:");
          ...
          for (Livro livro : livros) {
            System.out.println(
                cont + "-Título: " + livro.getTitulo() + "; Autor: " + livro.getAutor() + "; Data de publicação: "
                    + livro.getDataDePublicacao() + "; Quantidade de acervos: " + livro.getQtdDeCopias() + "\n");
            cont += 1;
          }
          String escolhaLivro = JOptionPane
              .showInputDialog("Digite a posição(número na lista) do ulivroque deseja remover:");
        ...
        if (opcaoParaEmprestimo.equals("1")) {
          ...
          for (int i = 0; i < emprestimos.size(); i++) {
            System.out.println(i + emprestimos.get(i).getUsuario().getNome() + " pegou o livro '"
                + emprestimos.get(i).getLivro().getTitulo() + "', na data:" + emprestimos.get(i).getData());
          }
        }
